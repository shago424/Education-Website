...
<head>
  ...
  <title>Educational Management</title>
  ...
  <nav style="background-color: #0B3861; color: white;" class="main-header navbar navbar-expand navbar-white navbar-light">
    ...
    <ul class="navbar-nav">
      ...
      <li class="nav-item d-none d-sm-inline-block">
        <a style="color: white" href="{{route('admin.dashboard')}}" class="nav-link">Home</a>
      </li>
    ...
    <ul class="navbar-nav ml-auto">
      ...
      <li class="nav-item dropdown">
        <a style="color: white" class="nav-link" data-toggle="dropdown" href="#">
          ...
          <span>{{ Auth::user()->name}} &nbsp;&nbsp;&nbsp; <i class="fas fa-sign-out-alt"></i>Logout</span>
        </a>
      ...
      <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        <div class="image">
         <img class="profile-user-img img-fluid img-circle"
                       src="{{(!empty(Auth::user()->image))?url('upload/userimage/'.Auth::user()->image):url('public/upload/usernoimage.png')}}"
...
<div id="fb-root"></div>
<script async defer crossorigin="anonymous" src="https://connect.facebook.net/en_GB/sdk.js#xfbml=1&version=v8.0" nonce="FoSFgpVj"></script>
