            ...
            <div class="row" style="position: absolute;margin-top: -100px;margin-left: 400px;">
                <div class="col-lg-12 text-center">
                    <div class="breadcrumb__text">
                        <h2 style="color: #CFD1C8">All Result Notice</h2>
        ...
        <thead>
            ...
            <tbody>
                    @foreach($results as $key => $result)
                      ...
                      <td> <a class="btn btn-danger btn-sm" href="{{asset('public/upload/postfile/'.$result->post_file)}}" target="_blank">Download</a></td>
                      <td>
